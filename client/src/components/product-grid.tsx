    ...
    <div>
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 ${featured ? 'lg:grid-cols-3' : 'lg:grid-cols-4'} gap-8`}>
        {finalProducts.map((product) => (
          <div key={product.id} className="elegant-card shimmer-effect group">
            <div className="relative overflow-hidden aspect-[3/4] mb-4">
              ...
              <button className="absolute top-4 right-4 bg-white/20 backdrop-blur-md p-2 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white/30 hover:scale-110">
